...
@Configuration
@MapperScan(basePackages = "xyz.tonalall.impl.mapper.Db1", sqlSessionFactoryRef = "db1SqlSessionFactory")
public class Db1DataSourceConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("db1DataSource") DataSource dataSource,
        ...
        Resource[] resources = resourcePatternResolver.getResources("classpath:mapper/Db1/*.xml");
